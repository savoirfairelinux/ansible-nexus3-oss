...
if (parsed_args.with_https_proxy) {
    if (parsed_args.https_proxy_username) {
        core.httpsProxyWithBasicAuth(parsed_args.https_proxy_host, parsed_args.https_proxy_port as int, parsed_args.http_proxy_username, parsed_args.https_proxy_password)
    } else {
